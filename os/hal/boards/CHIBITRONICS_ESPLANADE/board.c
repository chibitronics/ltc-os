  ...
  .ports = {
    {
      ...
      .pads = {
        ...
        /* PTA6*/ PAL_MODE_OUTPUT_PUSHPULL, /* PTA7*/ PAL_MODE_INPUT_PULLDOWN,/* PTA8*/ PAL_MODE_UNCONNECTED,      // rgb, dig1, ana0 (dio/i2c)
        /* PTA9*/ PAL_MODE_UNCONNECTED,     /*PTA10*/ PAL_MODE_UNCONNECTED,   /*PTA11*/ PAL_MODE_UNCONNECTED,      // ana1 (dio/i2c), nc, nc
        /*PTA12*/ PAL_MODE_INPUT_PULLDOWN,  /*PTA13*/ PAL_MODE_UNCONNECTED,   /*PTA14*/ PAL_MODE_UNCONNECTED,      // ana2 (led), nc, nc
    ...
    },
    {
      .port = IOPORT2,  // PORTB
      .pads = {
        /* PTB0*/ PAL_MODE_INPUT_PULLDOWN,  /* PTB1*/ PAL_MODE_ALTERNATIVE_3, /* PTB2*/ PAL_MODE_ALTERNATIVE_3,   // dig0, uart_rx, uart_tx
        /* PTB3*/ PAL_MODE_INPUT,           /* PTB4*/ PAL_MODE_UNCONNECTED,   /* PTB5*/ PAL_MODE_INPUT_ANALOG,    // mode_pb, ana3, audio
        /* PTB6*/ PAL_MODE_OUTPUT_PUSHPULL, /* PTB7*/ PAL_MODE_INPUT,         /* PTB8*/ PAL_MODE_UNCONNECTED,     // prog_statg, rst_level, nc
        /* PTB9*/ PAL_MODE_UNCONNECTED,     /*PTB10*/ PAL_MODE_INPUT_PULLDOWN,/*PTB11*/ PAL_MODE_INPUT_PULLDOWN,  // nc, ana0, ana1
        /*PTB12*/ PAL_MODE_UNCONNECTED,     /*PTB13*/ PAL_MODE_INPUT_PULLDOWN,/*PTB14*/ PAL_MODE_UNCONNECTED,     // nc, ana3, nc
